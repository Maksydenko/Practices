...
if x == y and x != z or x == z and x != y or y == z and y != x:
    ...
    print("\"Two variables store the same value, but the third one is different\" - this statement is incorrect")
...
print("The distance between these points :", str(distance))

slope = (y2 - y1) / (x2 - x1)
print("The slope of the line from the first point to the second:", str(slope))
...
if x1 and x2 == 0:
    ...
    print("\"Both points lie on the same line from the origin\" - this statement is incorrect")

print("The first point is above the second:", str(y1 > y2))
