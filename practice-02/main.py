...
if x == y and x != z or x == z and x != y or y == z and y != x:
    ...
    print('"Two variables store the same value, but the third one \
is different" - this statement is incorrect')
...
print("The distance between these points:", point_distance)
